...
window.abrirModalTabelaDinamica = () => {
    const form = document.querySelector("#modal .modal-main .content form");
    form.reset();
...
window.encontrarAncestral = (elemento, seletor) => {
...
window.excluirDados = async elen => {
...
window.carregarClientes = async (pagina) => {
